...
export const Recipe = () => {
    ...
    const saveRecipe = async() => {
        ...
        if (token === null || token === 'none') {
            ...
            dispatch(chooseCuisine(recipe.cuisine))
            dispatch(chooseSummary(recipe.summary))
            dispatch(chooseToken(token))
    ...
    if (isAuthenticated === 'true') {
        return (
        <Box sx={{backgroundColor:'#f6eddb', backgroundImage: `url(${ramen2})`, backgroundPosition:'center right', backgroundRepeat:'no-repeat', height:'100vh', backgroundAttachment:'fixed', marginBottom: '2vh'}}>
            <CssBaseline/>
            ...
            <br/><br/>
                <Grid container sx={myStyles.resultBox}>
                    ...
                    <Grid item xs={4} sx={myStyles.headerText}><p>{recipe.readyInMinutes}</p></Grid>
                    ...
                    <Grid item xs={12} sx={myStyles.otherText}><a href={recipe.sourceUrl} style={myStyles.aLink}>Check out the original source here.</a></Grid>
